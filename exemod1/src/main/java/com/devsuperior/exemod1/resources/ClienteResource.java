package com.devsuperior.exemod1.resources;
...
import com.devsuperior.exemod1.services.ClientService;
...
public class ClienteResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ClientDto> save(@PathVariable Long id, @RequestBody ClientDto dto) {
